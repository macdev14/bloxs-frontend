...
import { Box, FormControl, FormLabel, Input, Button, Heading, Text, Flex
} from '@chakra-ui/react';

import { useBank } from '../../BankContext';
import { useNavigate } from 'react-router-dom';

import { depositar } from '../../helpers';


const Deposito = ({ history }: any) => {
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    depositar(valor).then(res =>{ atualizarConta(); alert(res.msg )}).catch((e)=>{ console.log(e); refresh()});   
  };
  ...
  return (
    <Flex height="100vh" alignItems="center" justifyContent="center">
      ...
      <Box borderWidth={1} px={4} py={6} width="500px" borderRadius="md" shadow="md">
        ...
        <Heading mb={4} mt={4}>Depósito</Heading>
